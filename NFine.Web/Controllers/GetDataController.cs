...
namespace NFine.Web.Controllers
{
    public class GetDataController : Controller
    {
        ...
        {
            List<InvestConfigEntity> investConfigEntity = investConfigApp.GetInvestConfigList(8);
            int code = 0;
            string msg = "";
            return Json(new
            {
                code = code,
                msg = msg,
                data = investConfigEntity.Select(x => new
                {
                    x.F_Id,
                    x.F_Money,
                    x.F_VCoin,
                    //x.F_CreatorTime, 
                    //x.F_CreatorUserId,
                    //F_LastModifyTime = ((DateTime)x.F_LastModifyTime).ToString("yy-MM-dd"),//日期
                    //x.F_LastModifyUserId,
                })
        ...
        #region ===============新增充值秀豆配置
        //    [HttpPost]
        public JsonResult SetInvestConfig(InvestConfigEntity model)
        {
            int code = 0;
            string msg = "";
            string data = "";
        ...
        #region ===============删除某条充值秀豆配置
        //    [HttpPost]
        public JsonResult DelInvestConfig(string id)
        {
            int code = 0;
            string msg = "";
            string data = "";
        ...
        #region ===============修改充值秀豆配置列表 
        //    [HttpPost]
        public JsonResult UpdateInvestConfig(InvestConfigEntity model)
        {
            int code = 0;
            string msg = "";
            string data = "";
        ...
        {
            List<GiftEntity> giftEntity = giftApp.GetGiftList(count);
            int code = 0;
            string msg = "";
            return Json(new
            {
        ...
        #region ===============新增礼物秀豆配置
        //    [HttpPost]
        public JsonResult SetGift(GiftEntity model)
        {
            int code = 0;
            string msg = "";
            string data = "";
            ...
            {
                F_GiftName = model.F_GiftName,
                F_VCoin = model.F_VCoin,
                F_Gif_Url = model.F_Gif_Url,
                F_Png_Url = model.F_Png_Url
                //F_CreatorTime = DateTime.Now,
                //F_CreatorUserId = model.F_CreatorUserId,
                //F_LastModifyTime = DateTime.Now,
                //F_LastModifyUserId = "",
            ...
            giftApp.SubmitForm(entity, entity.F_Id);
            return Json(new
            {
                code = code,
                msg = msg,
        ...
        #region ===============删除某条礼物秀豆配置
        //    [HttpPost]
        public JsonResult DelGift(string id)
        {
            int code = 0;
            string msg = "";
            string data = "";
